# Django settings for moonbuck project.
...
DATABASES = {
    'default': {
        ...
        'HOST': 'D:\Programme_files\MySQL\data\data\mis',      # Set to empty string for localhost. Not used with sqlite3.
